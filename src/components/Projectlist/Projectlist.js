...
import MrRobotFan from '../../Assets/MrRobot-Fan.png'
          ...
          <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            <Col md={4} className="project-card">
              <ProjectCard
                imgPath={MrRobotFan}
                isBlog={false}
                title="Mr Robot Fan Site"
                description="Ultimate fan website for Mr. Robot series! Here, you can immerse yourself in the world of Elliot Alderson and friends, and connect with other passionate fans from around the globe. Our platform allows you to share your thoughts and opinions by posting and commenting on articles related to the show. You can also participate in fun quizzes and games, and gain access to exclusive behind-the-scenes content. Join us today and become part of the Mr. Robot community!"
                ghLink="#"
              />
            </Col>
